...
class player():
    ...
    def check(self):
        ...
        if results == 0:
            ...
            if command == "y" or command == "Y" or command == "":
                ...
                homeplanet = "Earth"
                languages = "English"
                player.create(callsign, fname, mname, lname, alignment, rank, branch, xp, kills, deaths,
                              locationx, locationy, whereami, health, species, age, birthday, homeplanet, languages)
    ...
    def create(callsign, fname, mname, lname, alignment, rank, branch, xp, kills, deaths, locationx, locationy, whereami, health, species, age, birthday, homeplanet, languages):
        connection = db.stdb()
